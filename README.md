...
## 2.1 Despliegue de CDK principal_stack_v
...
## 2.2 Despliegue de CDK secondary_stack_v.py
...
## 2.3 Construcción de la Imagen y Subida al ECR
...
# 2.4 Despliegue de los Manifiestos
...
# 2.5 Configuración de Route53, Health Checks y los ALBs

## 2.5.1 Crear Health Checks
...
## 2.5.2 Crear Registros de Route 53
...
## 2.5.3 Configurar el registro secundario
